...
INSERT INTO loans (id, name, address, amount_borrowed, interest_rate, interest_type, loan_date, due_date, manual_adjustment, amount_paid, notes)
VALUES 
('1', 'Marcão da Borracharia', 'Av. Brasil, 1940, Galpão B, São Paulo - SP', 5000.00, 20.00, 'SIMPLES_MENSAL', '2026-04-10', '2026-05-15', 350.00, 1500.00, 'Marcão já pagou R$ 1500 mas sumiu na última semana. Disse que o genro ia fazer PIX.'),
('2', 'Dona Creusa do Pastel', 'Rua das Palmeiras, 102, Próximo à Feira Municipal', 1500.00, 15.00, 'SIMPLES_MENSAL', '2026-05-02', '2026-06-02', 0.00, 0.00, 'Dona Creusa é pontual, excelente cliente. Paga em dinheiro vivo ou Pix de pastelaria.'),
('3', 'Cleiton ''Rebaixados'' Lima', 'Rua do Arrastão, 45, Beco 3, Diadema - SP', 3000.00, 10.00, 'SIMPLES_DIARIO', '2026-05-15', '2026-05-20', 150.00, 0.00, 'Cleiton do som automotivo. Já está atrasado há vários dias. Atitude suspeita.'),
('4', 'Paula da Odonto', 'Condomínio Golden Hills, Torre Sul, Apto 1403', 20000.00, 25.00, 'FIXO_UNICO', '2026-03-01', '2026-05-01', -1000.00, 19000.00, 'Acertou quase tudo, falta pouco. Super rica, mas chora desconto.');
...
SELECT 
    ...
    -- 3. Cálculo dinâmico do juro bruto dependendo da modalidade
    ROUND(
        CASE 
    ...
    -- 6. Total absoluto que o cliente deve pagar hoje para quitar a dívida
    ROUND(
        GREATEST(0, 
            amount_borrowed + 
            CASE 
